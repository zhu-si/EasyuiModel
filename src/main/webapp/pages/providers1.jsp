    ...
    <div class="container">
       <table id="dg" style="width:100%;height:529px" title="全体供应商列表" data-options="
            ...
            <thead>
                <tr>
                    ...
                    <th field="name" width="226">名称</th>
                    <th field="info" width="112">类别</th>
      ...
      <div id="tb" style="padding:0 30px;">
        <div class="conditions">
            <span class="con-span">编号: </span><input class="easyui-textbox" type="text" name="code" style="width:166px;height:35px;line-height:35px;"></input>
            <span class="con-span">名称: </span><input class="easyui-textbox" type="text" name="name" style="width:166px;height:35px;line-height:35px;"></input>
        ...
        <div class="opt-buttons">
            <a href="#" class="easyui-linkbutton" data-options="selected:true"  onclick="addwin();">新增</a>
